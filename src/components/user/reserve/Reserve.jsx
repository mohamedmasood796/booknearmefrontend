...
function Reserve({ setOpen, hotelId }) {
    ...
    const { data, loading, error } = useFetch(`https://booknearmeserver.hamrix.store/api/hotels/room/${hotelId}`)
    ...
    const handleClick = async () => {
        try {
            await Promise.all(
                ...
                const res=axios.put(`https://booknearmeserver.hamrix.store/api/rooms/availability/${roomId}/${roomNumberId}`,{dates:alldates})
                return res.data
            }))
        } catch (error) {
